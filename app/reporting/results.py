...
def _resolve_output_root(output_root: Optional[str] = None) -> str:
    return str(output_root) if output_root is not None else str(OUTPUT_ROOT)
...
def append_raw_result(row: Dict[str, Any], output_root: Optional[str] = None) -> None:
    output_root = _resolve_output_root(output_root)
...
def update_summary_statistics(output_root: Optional[str] = None) -> None:
    output_root = _resolve_output_root(output_root)
